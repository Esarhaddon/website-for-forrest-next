export default () => (
  <div className="flex flex-col items-center px-4">
    <div className="w-11/12 sm:w-7/12 md:w-6/12 leading-loose flex flex-col items-center lg:block lg:ml-16 mt-20 md:mt-8 sm:mt-20 lg:text-left text-justify mb-4">
      ...
      <p className="mb-4">
        Deserunt deserunt aliqua enim minim non consequat labore tempor. Nisi do
        labore ipsum ipsum velit. Mollit labore incididunt aliqua veniam Lorem
        cillum incididunt cillum consectetur. Ut reprehenderit id fugiat nostrud
        ad consequat aute nulla. Culpa culpa commodo cillum commodo aute non in
      ...
      <p className="mb-4">
        ...
        nostrud consequat. Aliqua ullamco sit fugiat eiusmod ut. Officia duis ex
        eiusmod dolor tempor ut voluptate consequat consectetur exercitation.
      </p>
    </div>
  </div>
)
